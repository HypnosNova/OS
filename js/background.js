...
function init() {
	...
	document.getElementById("osMain").appendChild(canvas);
	...
	document.getElementById("showcode").appendChild(button);
	...
	document.getElementById("showcode").appendChild(select);

	compileButton = document.createElement('button');
	compileButton.textContent = 'compile';
	compileButton.style.visibility="hidden";
	compileButton.style.position="absolute";
	compileButton.style.right="20px";
	compileButton.style.top="20px";
	compileButton.addEventListener('click', function(event) {

		compile();

	}, false);
	document.getElementById("codeContainer").appendChild(compileButton)
	// from helper.js
	add_server_buttons();
	...
	code = CodeMirror(document.getElementById("codeContainer"), {
		lineNumbers: true,
		matchBrackets: true,
		indentWithTabs: true,
		tabSize: 8,
